const translations = {
  ...
  uk: {
    ...
    songChords: "Акорди",
    detectChords: "Визначити акорди",
    detectingChords: "Визначаємо акорди...",
    hideChords: "Сховати акорди",
    showChords: "Показати акорди",
    deleteChords: "Видалити акорди",
    confirmDeleteChords: "Ви впевнені, що хочете видалити визначені акорди?",
