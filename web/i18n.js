const translations = {
  ...
  uk: {
    ...
    featureTuner: "Тюнер",
    featureMore: "Скоро ще",
    tunerTitle: "Вокальний тюнер",
    tunerHint: "Скоро: відстеження висоти й підказки для вокалу.",
    futureTitle: "Скоро додамо більше функцій",
    futureHint: "Цей екран уже готовий до нових музичних інструментів.",
    newSplit: "Новий",
